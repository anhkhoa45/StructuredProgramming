...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{!! route('backend.setting.user.create') !!}">{!! trans('backend/user.add_user') !!}</a></li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <div class="box-title">
                        <h3 class="box-title">{!! trans('backend/user.add_user') !!}</h3>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body no-padding">
                    <!-- form start -->
                    <form class="form-horizontal" method="POST" action="{!! route('backend.setting.user.store') !!}" enctype= "multipart/form-data">
                        ...
                        <div class="form-group {!! $errors->has('password') ? 'has-error' : '' !!} " >
                            <label class="col-sm-2 control-label"><span class="required">*</span> {!! trans('backend/user.password') !!}</label>
                            <div class="col-sm-9">
